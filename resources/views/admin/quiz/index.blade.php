            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                 ...
                 <div class="form-group{{ $errors->has('quiz_code') ? ' has-error' : '' }}">
                  {!! Form::label('quiz_code', 'Quiz Code') !!}
                  <span class="required">*</span>
                  {!! Form::text('quiz_code', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Quiz Code', 'required' => 'required']) !!}
                  <small class="text-danger">{{ $errors->first('title') }}</small>
                </div>
                ...
                <div class="form-group{{ $errors->has('timer') ? ' has-error' : '' }}">
                  {!! Form::label('timer', 'Quiz Time (in Seconds)') !!}
                  {!! Form::number('timer', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Quiz Total Time (In Seconds)']) !!}
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                  {!! Form::label('level', 'Quiz Level') !!}
                  <span class="required">*</span>
                  {!! Form::number('level', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Quiz level', 'required' => 'required']) !!}

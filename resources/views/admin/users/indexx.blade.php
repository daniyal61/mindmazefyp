...
@include('message')
  @if ($auth->role == 'A')
    <div class="margin-bottom">
      <button type="button" class="btn btn-wave" data-toggle="modal" data-target="#createModal">Add Users</button>
                ...
                <div class="col-md-12">
                  <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                   ...
                   {{-- <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <span class="required">*</span>
                    {!! Form::text('hospital_name', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Enter Hospital Name']) !!}

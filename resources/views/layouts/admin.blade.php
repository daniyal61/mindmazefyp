    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if ($auth->role == 'A')
          ...
          <li class="{{$users}}"><a href="{{url('/admin/users')}}" title="Students"><i class="fa fa-users"></i> <span>Users</span></a></li>
          ...
          <li class="{{$all_re}}" style="display: none;"><a href="{{url('/admin/all_reports')}}" title="Student Report"><i class="fa fa-file-text-o"></i> <span>Users Report</span></a></li>
          <li class="{{$top_re}}" style="display: none;"><a href="{{url('/admin/top_report')}}" title="Top Student Report"><i class="fa fa-user"></i> <span>Top Users Report</span></a></li>
          <li><a href="{{url('/admin/achievements')}}" title="My Achievements"><i class="fa fa-file-text-o"></i>
        ...
        @elseif ($auth->role == 'S')
          ...
          <li><a href="{{url('/admin/addfriend')}}" title="My Profile"><i class="fa fa-file-text-o"></i> <span>Add Friend</span></a></li>
          <li><a href="{{url('/admin/myfriend')}}" title="My Profile"><i class="fa fa-file-text-o"></i> <span>My Friend</span></a></li>
          <li><a href="{{url('/admin/myinvites')}}" title="My Profile"><i class="fa fa-file-text-o"></i> <span>Invites</span></a></li>
          <li><a href="{{url('/admin/sendedinvites')}}" title="My Profile"><i class="fa fa-file-text-o"></i> <span>Sended Invites</span></a></li>

          <li><a href="{{url('/user/achievements')}}" title="My Achievements"><i class="fa fa-file-text-o"></i> <span>Achievements</span></a>
          </li>
